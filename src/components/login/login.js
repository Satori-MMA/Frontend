...
export const Login = () => {
    ...
    const handleSummit = async (e) => {
        e.preventDefault();
        await tokenAuth({ variables: { email: datalogin.email, password: datalogin.password } });
                    ...
                    <Col lg={4} md={6} sm={12} className="pt m-auto shadow-sm rounded-lg">
                        <Form className="form-border"
                            ...
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <InputGroup>
                                    <InputGroup.Text className="icon-login">
                            ...
                            <Button className="button-login-google" variant={COLORS.lightGray} type="submit">

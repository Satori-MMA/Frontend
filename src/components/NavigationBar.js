      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          {isLogged === 2 ? (
            ...
            <NavDropdown title="Perfil" id="basic-nav-dropdown" icon={<FaUserCircle color="red" size={30}/>}>
            <NavDropdown.Item  as={Link} to="/profile">Ir al Perfil</NavDropdown.Item>
            <NavDropdown.Item as={Link} to="/profileupdate" >Editar Informacion</NavDropdown.Item>            
            <NavDropdown.Divider />
